...
class FinancialFeatureEngineer:
    ...
    def transform(self, X):
        ...
        X_copy['ingreso_disponible'] = X_copy['salario_cliente'] - X_copy['cuota_pactada'] - X_copy['total_otros_prestamos']
...
def create_preprocessing_pipeline():
    ...
    Returns:
        tuple: (date_engineer, financial_engineer, column_transformer)
    """
...
def load_and_prepare_data(file_path, test_size=0.2, random_state=42):
    ...
    X_processed, y, feature_names, preprocessor, date_engineer, financial_engineer = prepare_features(df)
