...
try:
    ...
    print("⚠️  imbalanced-learn no está instalado – se usará class_weight='balanced' solamente.")
...
def main():
    ...
    try:
        ...
        # drop_leakage=True elimina la columna 'puntaje' (alta correlación con target)
        ...
        # SMOTE para corregir el fuerte desbalanceo de clases (ratio < 0.3)
        sampler = SMOTE(random_state=42) if _SMOTE_AVAILABLE else None
        if sampler:
            print("   ⚖️  SMOTE activado – se generarán muestras sintéticas de la clase minoritaria")
